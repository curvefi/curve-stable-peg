...
@notice Minimal Stable Peg pool implementation with no lending
...
### Admin functions ###
@external
def set_peg_keeper(_peg_keeper: address):
    assert msg.sender == self.owner  # dev: only owner
    self.peg_keeper = _peg_keeper

...
@given(
    donate_fee=strategy("int", min_value=1, max_value=10 ** 20),
    fee=strategy("int", min_value=0, max_value=10 ** 10 - 1),
)
def test_calc_profit(peg_keeper, swap, make_profit, donate_fee, fee, set_fees):
    """Increase virtual price and check generated profit."""
